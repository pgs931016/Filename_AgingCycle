...
% 루트 디렉토리 설정
rootDir = '/Users/g.park/Library/CloudStorage/GoogleDrive-gspark@kentech.ac.kr/공유 드라이브/BSL-Data/Data/Hyundai_dataset/AgingDOE_cycle2';
...
for i = 1:length(allFolders)
    ...
    folderParts = strsplit(rootDir, filesep);
        ...
        if length(parts) >= 3
            ...
            newFileName = sprintf('NE_FCC_%s_%d%s', prefix1, str2double(parts{2}), fileExt);
